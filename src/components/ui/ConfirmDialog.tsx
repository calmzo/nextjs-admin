...
const getIconConfig = (type: ConfirmDialogType) => {
  switch (type) {
    case "success":
      return {
        bgClass: "fill-success-50 dark:fill-success-500/15",
        iconClass: "fill-success-600 dark:fill-success-500",
        icon: (
          <path
            fillRule="evenodd"
            clipRule="evenodd"
    ...
    case "info":
      return {
        ...
        iconClass: "fill-blue-light-500 dark:fill-blue-light-500",
        icon: (
          <path
            fillRule="evenodd"
            clipRule="evenodd"
    ...
    case "danger":
      return {
        ...
        iconClass: "fill-error-600 dark:fill-error-500",
        icon: (
          <path
            fillRule="evenodd"
            clipRule="evenodd"
...
const getButtonConfig = (type: ConfirmDialogType) => {
  switch (type) {
    case "success":
        ...
        <div className="flex items-center justify-center w-full gap-3 mt-5">
          {showCancelButton && (
            <button
              ...
              onClick={onClose}
              disabled={loading}
              className="flex justify-center w-full px-4 py-3 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg shadow-theme-xs hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {cancelText}
            </button>
          )}
          <button
            ...
            onClick={onConfirm}
            disabled={loading}
            className={`flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg shadow-theme-xs sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed ${buttonClass}`}
          >
            {loading ? (
