...
export default function NotificationsPage() {
  ...
  return (
    <>
      <PageMeta
        title="Next.js Notifications | TailAdmin - Next.js Admin Dashboard Template"
        description="This is Next.js Notifications  page for TailAdmin - Next.js Tailwind CSS Admin Dashboard Template"
      />
